...
public class Culture extends Task {
    public Culture(Context context) {
        super(context);
    }
    ...
    public String task1Q = "Every time I travel, I learn wonderful, strange, amazing and interesting things ______________________ cultures.";

    public String task1A = "about other";

    public String task2 = "2.  Восстановите пропуски в предложении";

    public String hint2 = "Введите пропущенный фрагмент...";

    public String task2Q = "When I went to America I understood Americans ______________________ very different people.";

    public String task2A = "and Brits are";

    public String hint3 = "Введите исправленное предложение...";

    public String task3 = "3.\tВосстановите порядок слов в предложении";

    public String task3Q = "I’m really <u>the in interested other of culture</u> countries.";

    public String task3A = "I’m really interested in the culture of other countries.";

    public String hint4 = "Введите исправленное предложение...";

    public String task4 = "4.\tВосстановите порядок слов в предложении";

    public String task4Q = "Understanding <u>very culture other is the of people</u> important.";

    public String task4A = "Understanding the culture of other people is very important.";
    ...
    public String task5Q = " The world is becoming <u>emsrlla</u>, so I think this is happening.";

    public String task5A = "smaller";
    ...
    public String task6Q = "One of the biggest <u>russeprsi</u> I had was when I went to the USA as a child.";

    public String task6A = "surprises";

    public String hint7 = "Введите перевод...";

    public String task7 = "7.\tПереведите предложение на русский язык";

    public String task7Q = "I’m really interested in the culture of other countries.";

    public String task7A = "Я действительно интересуюсь культурой других стран.";

    public String hint8 = "Введите перевод...";

    public String task8 = "8.\tПереведите предложение на русский язык";

    public String task8Q = "If everyone really tried to learn about other cultures, the world would be a more peaceful place.";

    public String task8A = "Если бы каждый действительно пытался узнать о других культурах, мир был бы более спокойным местом.";

    public String task9 = "9.\tВерно ли данное утверждение?";

    public String task9Q = "I don’t know why, but I always think other cultures are more interesting than my own culture.";

    public Boolean task9A = true;

    public String task10 = "10.\tВерно ли данное утверждение?";

    public String task10Q = "I’m English so I thought Americans had the same culture as me.";
